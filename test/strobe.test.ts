...
test('initialize STROBE-128', () => {
  ...
  expect(s).toSqueeze([
    0x76, 0x65, 0x56, 0x10, 0x2f, 0x14, 0x97, 0xe2, 0x16, 0x6, 0x82, 0xa7, 0x20,
    0x65, 0x32, 0x81, 0x1f, 0xb8, 0x2, 0xc5, 0xdf, 0x91, 0xe5, 0x31, 0x3f, 0x26,
    0x2a, 0x68, 0xfc, 0x5c, 0x9f, 0xc6,
  ])
})
...
test('initialize STROBE-256', () => {
  ...
  expect(s).toSqueeze([
    0xd, 0x15, 0x39, 0x44, 0x4c, 0xc5, 0xef, 0x5a, 0x6b, 0x1b, 0xc0, 0x9a, 0xa,
    0xe4, 0xfd, 0xd1, 0x19, 0x29, 0xa5, 0x3, 0xf1, 0x50, 0x99, 0xf8, 0x53, 0x97,
    0xc3, 0xe1, 0x28, 0x6b, 0x37, 0x52,
  ])
})
...
test('sequence of operations', () => {
  ...
  expect(s).toSqueeze([
    0x8, 0x6, 0x34, 0x22, 0xb2, 0x34, 0x38, 0xf1, 0x8b, 0x52, 0x6f, 0xea, 0xe8,
    0x1a, 0x5a, 0x3a, 0xff, 0x0, 0x77, 0xcf, 0x88, 0x2, 0x86, 0x59, 0x1c, 0x92,
    0xf4, 0xc2, 0xc7, 0x42, 0x6c, 0x53,
  ])
})
...
test('metadata', () => {
  ...
  expect(s).toSqueeze([
    ...
    0x52, 0x95, 0x64, 0x2, 0xfc, 0xd7, 0x79, 0xe, 0xe5, 0xef, 0xaf, 0xa7, 0x12,
    0x1c, 0x1e, 0x47, 0x84, 0xa5, 0x4d, 0x8f,
  ])
})
